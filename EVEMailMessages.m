                         ...
                         CharacterId:(NSNumber *)characterId
{
   ...
   if (self)
   {
      ...
      self.commonName = @"Mail Messages";
      [self.uri appendString:@"char/MailMessages.xml.aspx"];
      [self.uriArguments addEntriesFromDictionary:@{@"keyID":keyId,
                                                    @"vCode":vCode,
                                                    @"characterID":[characterId stringValue]}];
      self.cakAccessMask = @2048;
...
-(void)configureObjectBuilders
{
   ...
   [self.objectBlueprints addObject:evemail];
