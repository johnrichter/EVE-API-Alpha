                         ...
                         CharacterId:(NSNumber *)characterId
{
   ...
   if (self)
   {
      ...
      self.commonName = @"Contract Bids";
      [self.uri appendString:@"char/ContractBids.xml.aspx"];
...
-(void)configureObjectBuilders
{
   ObjectBlueprint *bid = [[EVEContractBid new] objectBlueprint];
   [bid setXmlKeypath:@"eveapi.result.rowset.row"];
   
   // Add the blueprints to our collection
   [self.objectBlueprints addObject:bid];
...
-(void)requestOperationSucceededWithObjects:(NSArray *)objects
{
   ...
   {
      if ([object class] == [EVEContractBid class])
      {
         [self.bids addObject:object];
      }
   }
