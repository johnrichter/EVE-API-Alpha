...
-(EVESovereignty *)init;
{
   ...
   if (self)
   {
      ...
      self.commonName = @"Sovereignty";
      [self.uri appendString:@"map/Sovereignty.xml.aspx"];
...
-(void)configureObjectBuilders
{
   ObjectBlueprint *solarSystem = [[EVESolarSystemSovereignty new] objectBlueprint];
...
-(void)requestOperationSucceededWithObjects:(NSArray *)objects
{
   ...
   {
      if ([object class] == [EVESolarSystemSovereignty class])
      {
