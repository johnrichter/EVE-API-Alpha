...
@interface EVEContactNotifications ()
                                 ...
                                 CharacterId:(NSNumber *)characterId
{
   ...
   if (self)
   {
      ...
      self.commonName = @"Contact Notifications";
      [self.uri appendString:@"char/ContactNotifications.xml.aspx"];
...
-(void)configureObjectBuilders
{
   ObjectBlueprint *notification = [[EVEContactNotification new] objectBlueprint];
...
-(void)requestOperationSucceededWithObjects:(NSArray *)objects
{
   ...
   {
      if ([object class] == [EVEContactNotification class])
      {
